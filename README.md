...
For everything related to how to use the RDKit cartridge, you can refer to the related [documentation](https://www.rdkit.org/docs/Cartridge.html) or [repository](https://github.com/rdkit/rdkit).
